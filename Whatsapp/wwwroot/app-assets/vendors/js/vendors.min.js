/*! jQuery v3.6.0 | (c) OpenJS Foundation and other contributors | jquery.org/license */ ! function (e, t) {
    ...
    function () {
        ...
        for (v = {
            ...
            var n, i;
            if (null == e && (e = "options"), null == t && (t = !0), i = document.querySelector("[data-pacee-" + e + "]")) {
                if (n = i.getAttribute("data-pacee-" + e), !t) return n;
                try {
                    return JSON.parse(n)
                } catch (e) {
        ...
        K(J, Y = Error), r = J, Z.prototype.getElement = function () {
            ...
            if (null == this.el) {
                ...
                this.el = document.createElement("div"), this.el.className = "pacee pacee-active", document.body.className = document.body.className.replace(/(pacee-done )|/, "pacee-running ");
                var t = "" !== C.className ? " " + C.className : "";
                this.el.innerHTML = '<div class="pacee-progress' + t + '">\n  <div class="pacee-progress-inner"></div>\n</div>\n<div class="pacee-activity"></div>', null != e.firstChild ? e.insertBefore(this.el, e.firstChild) : e.appendChild(this.el)
            }
            return this.el
        }, Z.prototype.finish = function () {
            var e = this.getElement();
            return e.className = e.className.replace("pacee-active", "pacee-inactive"), document.body.className = document.body.className.replace("pacee-running ", "pacee-done ")
